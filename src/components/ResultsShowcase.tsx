...
const beforeItems = ["Wallet full of faded receipts", "Hours lost to spreadsheets", "Sayang spending you can't track", "Anxiety about where pera goes"];
const afterItems = ["Expenses logged in seconds", "Automatic categorization", "AI finds tipid opportunities", "Clear picture of your finances"];
const testimonials = [{
  name: "Maria Santos",
  ...
  return <section className="py-20 bg-background">
      <div className="container px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="p-8 bg-muted/50 border-destructive/20">
              ...
              <ul className="space-y-4">
                {beforeItems.map((item, index) => <li key={index} className="flex items-start gap-3">
            ...
            <Card className="p-8 bg-gradient-to-br from-accent/5 to-accent/10 border-accent/30 shadow-lg">
              ...
              <ul className="space-y-4">
                {afterItems.map((item, index) => <li key={index} className="flex items-start gap-3">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-foreground mb-4">What Users Say About Resiboko</h2>
            <p className="text-xl text-muted-foreground">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="p-6 hover:shadow-lg transition-all duration-300">
